...
#define COLOR uint16_t  // The type of the color (unsigned short)
...
typedef enum
{
    L2R_U2D = 0, // The display interface is displayed , left to
                 // right, up to down
    L2R_D2U,
    R2L_U2D,
    R2L_D2U,
...
void LCD_SetWindow(POINT Xstart, POINT Ystart, POINT Xend,
                   POINT Yend);
